...
public class UserModel {
    ...
    public UserModel(int user_id, String email, String username, String register_date, int points, int total_check_in, Date last_claim_date) throws ParseException {
